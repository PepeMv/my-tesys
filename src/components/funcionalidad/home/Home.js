...
const Home = () => {
  ...
  const { img1, img2, img3, img4 } = useSelector(
    (state) => state.restaurante.imagenes
  );
  ...
  const renderBody = () => (
    <div className={classes.paper}>
      <Paper>
        ...
        <MostrarQrReader
          abrirqr={abrirqr}
          handleCerrarQr={handleCerrarQr}
          setMesaEscaneada={setMesaEscaneada}
          setTipoPedido={setTipoPedido}
          setUbicacionHome={setUbicacionHome}
        />
        <MostrarLocationPicker
          abrirlocation={abrirlocation}
          handleCerrarLocation={handleCerrarLocation}
          setUbicacionHome={setUbicacionHome}
          setTipoPedido={setTipoPedido}
          setMesaEscaneada={setMesaEscaneada}
        />
